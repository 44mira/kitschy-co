	...
	<div class="flex-1">
      ...
      <!-- cards -->
		{#each theme as { bgStart, icon }, index}
			<div
				class="callcard absolute bottom-0 left-[20%] sm:left-[30%] md:left-[32%] lg:left-[34%] xl:left-[40%]"
	  ...
	  <!-- spinning stamp -->
	  <button class="absolute bottom-[150px] left-[50%] transform -translate-x-1/2 z-[5]" onclick={nextTheme}>
