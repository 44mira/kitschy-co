...
STORAGES = {
    ...
    "staticfiles": {
        "BACKEND": "django.contrib.staticfiles.storage.StaticFilesStorage",  # This keeps static files local
    },
}
...
STATICFILES_DIRS = [
    os.path.join(
        BASE_DIR, "kitschy_api/static"
    ),  # Point to your app's static folder
]
